    ...
    <div className="flex flex-col items-center justify-center p-8">
      <Accordion className="w-[90%] md:w-[600px] lg:w-[700px]" type="single" collapsible>
        <AccordionItem value="item-1">
          ...
          <AccordionContent>The wedding and the reception will take place on Sunday, July 13th 2025 at 5pm.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            ...
            <Link target="_blank" className="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://maps.app.goo.gl/3sz5jjB6FsVPSCw97">
              {"here"}
            </Link>.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            The dress code is cocktail attire. We recommend dressing comfortably for the venue and weather.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-6">
          ...
          <AccordionContent>
            Yes, we have reserved rooms at Courtyard Novato. Please mention our wedding when booking to
            receive a special rate. There are additional hotels within the area that you are welcome to use too.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-7">
          <AccordionTrigger className="text-left">What time should I arrive?</AccordionTrigger>
          <AccordionContent>
            Please arrive by 4:30pm to ensure you&apos;re seated before the ceremony
            begins.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-11">
          ...
          <AccordionContent>
            Please check your invitation for a &quot;+1&quot; indication. If your invitation does not include a +1, you are not able to bring a guest. If you have any
        ...
        <AccordionItem value="item-12">
          ...
          <AccordionContent>
            Please let us know if you have any specific dietary needs when you RSVP. Must request ahead of time.
          </AccordionContent>
        </AccordionItem>
